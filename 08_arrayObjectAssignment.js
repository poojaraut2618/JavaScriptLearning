...
console.log("=============Bank Details using for of loop===========");
var bankArray = [axisBank, sbiBank, iciciBank, kotakBank, hdfcBank, punjabBank];
for (const bank of bankArray) {
 
    console.log(`Bank Details: ${bank.bankName}, Located in : ${bank.location}`);
...
for (const bank of bankArray) {
    ...
    if(bank.bankName == "Kotak Mahindra Bank"){
