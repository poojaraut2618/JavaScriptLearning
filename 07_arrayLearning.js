...
console.log(`accessing even position`);
for(let index = 0; index < arrayOfNumbers.length; index++){
    if(index%2 == 0){
    const element = arrayOfNumbers[index];
    console.log(element);
...
arrayOfNum.push(3); //adding element in last position
...
console.log(`======== concat () ==========`);
var arrayOfNum = [4, 5, 6, 8, 9, 33, 66];
var arrayOfNames = ["Moni", "Jenny", "Shenny", "Tony"];
var arrayOfCities =["Pune", "Mumbai", "Banglore"]
